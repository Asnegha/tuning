...
#         "Below is a Hindi instruction that describes a task, paired with the Hindi input that provides further context. "
#         "Write a Hindi response that appropriately completes the request.\n\n"
#         "### Instruction:\n{instruction}\n\n### Input:\n{input}\n\n### Response:"
#     ),
#     "prompt_no_input": (
#         "You are a Hindi language expert.\n\n"
...
def main(args):
    ...
    print('before', model.adapter_query.weight[:, 0])
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats, model = train_one_epoch(
            model, data_loader_train, optimizer, device, epoch, loss_scaler, log_writer=log_writer, args=args,scheduler=scheduler
        )
...
if __name__ == "__main__":
    ...
    wandb.init(project="prefix_tuning", name="hindi_prefix_tuning_3e-3_v1", config=args)
    if args.output_dir:
